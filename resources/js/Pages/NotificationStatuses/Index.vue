...
const throttledHandler = throttle(() => {
    Inertia.get("/notification-statuses", pickBy(form), { preserveState: true });
}, 150);
...
<template>
    <Head title="List Notification Statuses" />
    <ConsoleLayout>
        <div class="bg-gray-200 dark:bg-gray-800">
            <div class="pt-14 pr-8 flex justify-between">
                ...
                >
                    ...
                    <span>&nbsp;Notification Statuses</span>
                </span>
            </div>
            <div class="pt-7 pb-7 pl-4 pr-8 flex justify-between">
                ...
                <Link
                    ...
                    href="notification-statuses/create"
                >
                    <span>Create</span>
                    <span class="hidden md:inline">&nbsp;Notification Status</span>
                </Link>
            </div>
            <div
            ...
            >
                ...
                >
                    ...
                    >
                        <tr>
                            <th scope="col" class="px-6 py-3">Notification Status</th>
                    ...
                    <tbody>
                        <tr
                            v-for="notification_status in notification_statuses.data"
                            :key="notification_status.id"
                        ...
                        >
                            <td class="px-6 py-4">
                                <Link
                                    ...
                                    :href="`/notification-statuses/${notification_status.id}/edit`"
                                >
                            ...
                            <td class="px-6 py-4">
                                ...
                                >
                                    <div
                                        class="flex items-center"
                                        v-if="notification_status.is_active == 1"
                                    >
                                        <div
                            ...
                            <td class="px-6 py-4">
                                <Link
                                    ...
                                    :href="`/notification-statuses/${notification_status.id}/edit`"
                                >
                                    {{ notification_status.created_by }}
                                </Link>
                            </td>                            
                            <td class="px-6 py-4">
                                <Link
                        ...
                        <tr v-if="notification_statuses.data.length === 0">
                            <td
                                colspan="5"
                ...
                <div id="pagination-section">
                    <Pagination
                        ...
                        :links="notification_statuses.links"
                    ></Pagination>
                </div>
            </div>
        </div>
